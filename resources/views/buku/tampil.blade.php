            ...
            @forelse ($buku as $item)
                <div class="col-auto my-2" style="width:18rem;">
                    <div class="card mx-2 my-2" style="min-height:28rem;">
                        ...
                        @else
                            <img class="card-img-top" style="height:300px;" src="{{ asset('/images/noImage.jpg') }}">
                        @endif
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="detai-buku">
                                ...
                                <p class="card-text m-0">
                                    Kategori : <span class="text-primary">{{ $item->kategori_buku->pluck('nama')->implode(', ') }}</span>
                            </p>
                                <p class="card-text m-0">Lokasi : {{ $item->lokasi }}</p>
                            ...
                            @if (Auth::user()->isAdmin == 0)
                                <div class="button-area">
                                    <button class="btn-sm btn-info px-2"> <a href="/buku/{{ $item->id }}"
                                    style="text-decoration: none; color:white;">Detail</a></button>
                                    <button class="btn-sm btn-danger px-4"><a href="{{ route('peminjaman.create', $item->id) }}" 
